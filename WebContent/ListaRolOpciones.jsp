...
<meta name="author" content="">
    ...
    <title>Modulo Evaluación- Lista de Rol Opciones</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                     <h1 class="h3 mb-2 text-gray-800">Lista de Rol Opciones</h1>
                    ...
                    <nav aria-label="breadcrumb">
								  <ol class="breadcrumb">
								    ...
								    <li class="breadcrumb-item active" aria-current="ListaRolOpciones.jsp">Lista de Rol Opciones</li>
								  </ol>
								</nav>
               	...
               	<!-- DataTales Example -->
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Lista de Rol Opciones
							<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" 
                           title="Lista de las opciones que estan disponibles para los roles pueden o han sido asignadas a un usuario, en esta sección podrás buscar sus datos."></i>					
							</h6>
						</div>
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered" id="tblrolopc" width="100%"
									cellspacing="0">
									   <thead>
                                        <tr>
											<th>ID</th>
                                    ...
                                    listaRolopc = dtr.listarRolopc();
                                    
                                    for(VW_rol_opciones vwr: listaRolopc)
                                    {
                                    %>
                                 
                                    <tr>
                                      <td><%=vwr.getId_rol_opciones() %></td>
                                      <td><%=vwr.getOpcion() %></td>
                                      <td><%=vwr.getRol() %></td>
                                      <td><%=vwr.getDescripcion() %></td>  
                                      <td>
                   							<span>
                    							<a onclick="eliminarOpcion(<%=vwr.getId_rol_opciones()%>);">
   ...
   <!-- Logout Modal-->
	...
	<script>
	 ...
	 <script type="text/javascript">
		...
		function valoreditar(idrolopcion)
		{
			window.location.href="EditarRolOpc.jsp?idrolopcionrol="+idrolopcion;
			location.reload
		}		
		function eliminarOpcion(id)
		{
            ...
            confirm(function(e, btn){
                e.preventDefault();
                window.location.href = "SLeliminarRolOpc?id="+id;
            },
            function(e,btn){
                e.preventDefault();
            });

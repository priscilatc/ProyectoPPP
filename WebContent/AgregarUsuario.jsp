...
<title>Modulo Evaluación - Agregar Usuario</title>
				...
				<div class="container-fluid">
					...
					<nav aria-label="breadcrumb">
								  <ol class="breadcrumb">
								    ...
								    <li class="breadcrumb-item active" aria-current="AgregarUsuario.jsp">Agregar Usuario</li>
								  </ol>
								</nav> 
                     
					<form class="form-group" method="post" action="./SLguardarUsuario">
					...
					<div class="form-group">
						...
						<label class="col-sm-2 control-label text-gpromedix">Contraseña: </label>
						<div class="col-sm-6">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<span>NombreUsuario: </span> <input type="text"
								class="form-control" id="nomUsuario" name="nomUsuario" /> 

				...
				<div class="container-fluid">
					...
					<nav aria-label="breadcrumb">
                 				 <ol class="breadcrumb">
								    ...
								    <li class="breadcrumb-item active" aria-current="EditarDocente.jsp">Editar Docente</li>
								  </ol>
								</nav>
					...
					<form class="form-group" method="post" action="./SLgestionDocente">
						...
						<input type="hidden" id="opcion" name="opcion" value="2" required/>
							...
							<label class="col-sm-2 control-label text-rpromedix">Usuario</label>							
								    <div class="col-sm-6">							    
								      <select name="idusuario" id="idusuario" class="form-control" disabled="disabled" required>								    	
								      <%

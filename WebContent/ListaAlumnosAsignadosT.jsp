...
<%
    //Limpia la CACHE del navegador
		...
		DTTutorTecnico dte = new DTTutorTecnico();
		ArrayList<VW_alumnosasignados_tutort> alumnosasignados = new ArrayList<VW_alumnosasignados_tutort>();
		
		alumnosasignados =dte.getAlumnosAsignados(dtu.conseguirID(loginUser));
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					title="Lista de Alumnos Asignados en la cual puede ver sus datos y evaluar su desempeño en sus Practicas Preprofesionales"></i>
							</h6>
							...
							<div class="table-responsive">
								<table class="table table-bordered" id="tblalumnos" width="100%"
                                    ...
                                    <tbody>
                                     <tr>
                                     <%
                                     for (VW_alumnosasignados_tutort vwa: alumnosasignados)
                                     {
                                     %>
                                     <td><%=vwa.getNombre()%></td>
                                     <td>
                                      <span>
              								...
              								<a onclick="verDetalle(<%=vwa.getIdestudiante() %>);">
              									<i class="fas fa-align-justify" data-toggle="tooltip" data-placement="right" title="Detalle"></i>
              								</a>
              							</span>
                                     </td>
                                     </tr>

<%@page import="vistas.*" %>
<%@page import="datos.*" %>
<%@page import="entidades.TutorTecnico" %>
...
<title>Modulo Evaluación- Editar Tutor Técnico</title>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Editar Tutor Técnico </h1>
					<nav aria-label="breadcrumb">
				
					 <ol class="breadcrumb">
								    <li class="breadcrumb-item"><a href="index.jsp">Inicio</a></li>
								    <li class="breadcrumb-item"><a href="ListaTutorTecnico.jsp">Lista de Tutores Técnicos</a></li>
								    <li class="breadcrumb-item active" aria-current="EditarTutorTecnico.jsp">Editar Tutor Técnico</li>
								  </ol>
								</nav>
					<%
					...
					t= dtt.getTutor(Integer.parseInt(idtutor));
            		 %>
					<form class="form-group" method="post" action="./SLgestionTutor">
						<div class="form-group">
						<input hidden="true" name="idtutor" value="<%=idtutor%>">
						<input type="hidden" id="opcion" name="opcion" value="2" required />						
								
								<label class="col-sm-2 control-label text-rpromedix">Usuario</label>
								    <div class="col-sm-6">								     
								      <select disabled="disabled" name="idusuario" id="idusuario" class="form-control" required>	
								      <%
										...
										if(u.getIdUsuario()==t.getIdTutor()){
										%>
								...
								<label class="col-sm-2 control-label text-rpromedix">Organización</label>
								    <div class="col-sm-6">								       
								      <select name="idorg" id="idorg" class="form-control" required>	
								      <%
							...
							<div class="col-sm-6">
								...
								data-placement="bottom" title="Min:2 Max:30" value="<%=t.getNombres()%>" required>
							...
							<div class="col-sm-6">								
								...
								data-placement="bottom" title="Min:2 Max:30"value="<%=t.getApellidos()%>" required>
						...
						<div class="col-sm-6">
							...
							data-placement="bottom" title="Min:10 Max:50" value="<%=t.getDireccion()%>">
						</div>	
						...
						<div class="col-sm-6">
							...
							data-placement="bottom" title="Max:8"value="<%=t.getCelular()%>">
						</div>	
						...
						<div class="col-sm-6">
							...
							placeholder="Ej:julio@gmail.com" data-toggle="tooltip"   minlength="10" maxlength="45"
							data-placement="bottom" title="Min:10 Max:45" value="<%=t.getCorreo()%>">
						</div>	
						...
						<div class="col-sm-6">
							...
							data-placement="bottom" title="Min:9 Max:10" value="<%=t.getCarneUca()%>">
						</div>
						...
						placeholder="Ej:001-200001-0000Y" data-toggle="tooltip" minlength="16" maxlength="20"
							data-placement="bottom" title="Min:16 Max:20" value="<%=t.getCedula()%>">
						</div>
						...
						<div class="col-sm-6">
							...
							data-placement="bottom" title="Min:20 Max:20" value="<%=t.getCargo()%>">
						</div>
						...
						placeholder="Ej:Licenciado" data-toggle="tooltip" minlength="3" maxlength="20"
							data-placement="bottom" title="Min:4 Max:20"value="<%=t.getTrato()%>">
						</div>

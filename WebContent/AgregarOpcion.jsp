...
<title>Modulo Evaluación - Agregar Opción</title>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Agregar Opción</h1>
					<nav aria-label="breadcrumb">
								  <ol class="breadcrumb">
								    <li class="breadcrumb-item"><a href="index.jsp">Inicio</a></li>
								    <li class="breadcrumb-item"><a href="ListaOpcion.jsp">Lista de Opciones</a></li>
								    <li class="breadcrumb-item active" aria-current="AgregarOpcion.jsp">Agregar  Opcion</li>
								  </ol>
								</nav>
					<%
					String idopcion = request.getParameter("idopcion");
            		 ...
            		 %>
					<form class="form-group" method="post" action="./SLgestionOpcion">
						<div class="form-group">
						<input hidden="true" name="idopcion" value="<%=idopcion%>">
						...
						<div class="col-sm-6">
							...
							placeholder="Ej:Agrega un nuevo docente" data-toggle="tooltip"   minlength="10" maxlength="30"
							data-placement="bottom" title="Min:10 Max:30" required>
						</div>
						<label class="col-sm-2 control-label text-gpromedix">URL: </label>
						<div class="col-sm-6">
							<input id="url" name="url" type="text" class="form-control has-gpromedix" 
							placeholder="Ej:AgregarDocente.jsp" data-toggle="tooltip"  minlength="6" maxlength="30"

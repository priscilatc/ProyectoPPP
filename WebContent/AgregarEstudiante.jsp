...
<title>Modulo Evaluación- Agregar Estudiante</title>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Agregar Estudiante</h1>
					<nav aria-label="breadcrumb">
								  <ol class="breadcrumb">
								    <li class="breadcrumb-item"><a href="index.jsp">Inicio</a></li>
								    <li class="breadcrumb-item"><a href="ListaEstudiante.jsp">Lista de Estudiantes</a></li>
								    <li class="breadcrumb-item active" aria-current="AgregarEstudiante.jsp">Agregar de Estudiante</li>
								  </ol>
								</nav>
					<%
					String idestudiante = request.getParameter("idestudiante");
					%>
					<form class="form-group" method="post" action="./SLgestionEstudiante">
						<div class="form-group">
						<input type="hidden" id="opcion" name="opcion" value="1" required />
						<input hidden="true" name="idestudiante" value="<%=idestudiante%>">
						...
						<label class="col-sm-2 control-label text-rpromedix">Coordinación</label>
						    <div class="col-sm-6">
						      <select name="idcoordinacion"class="form-control" required>
								...
								for(VW_coordinacion f : listaCoordinaciones)
								{
								%>
								<option value="<%=f.getIdcoordinacion() %>"><%=f.getNombre() %></option>
								<%
								}
								%>	
						      </select>
						...
						<div class="col-sm-6">
							<input id="condicion" name="condicion" type="text" class="form-control has-gpromedix" 
							placeholder="Ej:Actualmente laborando" data-toggle="tooltip"  minlength="4" maxlength="25"
							data-placement="bottom" title="Min:4 Max:25" required>
						</div>	
						
						<label class="col-sm-2 control-label text-rpromedix">Sexo</label>
						    <div class="col-sm-6">
						...
						<label class="col-sm-2 control-label text-gpromedix">Correo Institucional</label>
						<div class="col-sm-6">
							<input id="correoinstitucional" name="correoinstitucional" type="email" class="form-control has-gpromedix" 
						...
						<div class="col-sm-6">
							...
							data-placement="bottom" title="Min:9 Max:10" required> 
						</div>	

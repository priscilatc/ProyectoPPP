...
<meta name="author" content="">
    <title>Modulo Evaluación- Lista de Roles de Usuario</title>
         	...
         	<!-- DataTales Example -->
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Lista de Roles de Usuario 
							<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" 
                           title="Lista de los usuarios a los que se le han asignado un rol, en esta sección podrás buscar sus datos."></i>
                           </h6>
						</div>
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered" id="tblusuariorol" width="100%"
									cellspacing="0">
									<thead>
                                        <tr>
                                            <th>ID</th>                                                                                        
                                    ...
                                    listaUR = dtur.listarUR();
                                    
                                    for(VW_usuario_rol vwu: listaUR)
                                    {
                                    %>
                                    
                                    <tr>
                                       <td><%=vwu.getId_usuario_rol() %></td>
                                       <td><%=vwu.getRol() %></td>
                                       <td><%=vwu.getUsuario() %></td>
                                       <td>
                   							<span>
                    							<a onclick="eliminarUR(<%=vwu.getId_usuario_rol()%>);">

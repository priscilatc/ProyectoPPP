...
<meta name="author" content="">
    ...
    <title>Modulo Evaluación- Lista de Opciones</title>
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                     <h1 class="h3 mb-2 text-gray-800">Lista de Opciones</h1>
                  <nav aria-label="breadcrumb">
				 				  <ol class="breadcrumb">
								    <li class="breadcrumb-item"><a href="index.jsp">Inicio</a></li>
								    <li class="breadcrumb-item active" aria-current="ListaOpcion.jsp">Lista de Opciones</li>
								  </ol>
								</nav>
                    <!-- DataTales Example -->
                    		<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Lista de Opciones <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" 
                           title="Lista de las opciones diponibles en una página  del sistema,  en esta sección podrás agregar una nueva opción buscar, editar o eliminar sus datos."></i>	
							</h6>
						</div>
						<div class="card-body">
                    	
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tblopc" width="100%" cellspacing="0">
                                 <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Descripción</th>
                                    ...
                                    <tbody>                                   
	                                 <%
		                                ...
		                                for(VW_opcion vwo : listaOpciones)
		                                {
		                               %>
                                    <tr>
                                       <td><%=vwo.getIdopcion() %></td>
                                       <td><%=vwo.getDescripcion() %></td>
                                       <td><%=vwo.getUrl() %></td>
                                       <td>
											<span>
                  								<a onclick="eliminarOpcion(<%=vwo.getIdopcion()%>);">
                  									<i class="fas fa-trash" data-toggle="tooltip" data-placement="right" title="Eliminar"></i>
                  								</a>
                    						</span>
                    							<span>
                    								<a onclick="valoreditar(<%=vwo.getIdopcion() %>)">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
			                        <a href="AgregarOpcion.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
			                        class="fas fa-plus fa-sm text-white-50"></i> Agregar Nueva Opcion</a>                                           
			                    </div> 
                            </div>
                        </div>
                    </div>
  ...
  <!-- Logout Modal-->
	...
	<script type="text/javascript">
		...
		function valoreditar(idopcion)
		{
			window.location.href="EditarOpcion.jsp?idopcion="+idopcion;
			location.reload
		}
		...
		function eliminarOpcion(id)
		{
            ...
            confirm(function(e, btn){
                e.preventDefault();
                window.location.href = "SLeliminarOpcion?id="+id;
            },
            function(e,btn){
                e.preventDefault();
            });

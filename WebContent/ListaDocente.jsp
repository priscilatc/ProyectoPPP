...
<title>Modulo Evaluación - Lista de Docente</title>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Lista de Docente</h1>
				<nav aria-label="breadcrumb">
				 				  <ol class="breadcrumb">
								    <li class="breadcrumb-item"><a href="index.jsp">Inicio</a></li>
								    <li class="breadcrumb-item active" aria-current="ListaDocente.jsp">Lista de Docentes</li>
								  </ol>
								</nav>
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Lista de Docente
						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered" id="tbldocente" width="100%"
									cellspacing="0">									
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                    ...
                                    %>
                                      ...
                                      <td><%=vwd.getCiudad() %></td>                                     
                                      <td><%=vwd.getCelular() %></td>
                                      <td><%=vwd.getCorreo() %></td>
                                      <td><%=vwd.getCargo() %></td>
                                      <td><%=vwd.getTrato() %></td>
                                      <td><%=vwd.getCategoria() %></td>
                                      <td><%=vwd.getCoordinacion() %></td>
                                      <td><%=vwd.getUsuario() %></td>                                     
                                      <td>
						                <span>
              								<a onclick="eliminarDocente(<%=vwd.getId_docente()%>);">
              									<i class="fas fa-trash" data-toggle="tooltip" data-placement="right" title="Eliminar"></i>
              								</a>
              							</span>
              							<span>
              								<a onclick="valoreditar(<%=vwd.getId_docente() %>)">
								...
								<div class="d-sm-flex align-items-center justify-content-between mb-4">
			                        <a href="AgregarDocente.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
			                        class="fas fa-plus fa-sm text-white-50"></i> Agregar Nuevo Docente</a>                                           
			                    </div>
...
<!-- Logout Modal-->
	...
	<script type="text/javascript">
		...
		function valoreditar(id_docente)
		{
			window.location.href="EditarDocente.jsp?id_docente="+id_docente;
			location.reload
		}
		...
		function eliminarDocente(id)
		{
            ...
            confirm(function(e, btn){
                e.preventDefault();
                window.location.href = "SLeliminarDocente?id="+id;
            },
            function(e,btn){
                e.preventDefault();
            });			

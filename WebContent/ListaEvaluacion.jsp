...
<title>Modulo Evaluación - Lista de evaluación</title>
...
<body>
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Lista de evaluacion</h6>
							
						</div>
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered" id="tblevaluacion" width="100%"
									cellspacing="0">
                                    ...
                                    listaEvaluaciones = dte.listarEvaluaciones();
                                    
                                    for(VW_evaluacion vwe: listaEvaluaciones)
                                    {
                                    %>
                                    <tr>
								...
								<div class="d-sm-flex align-items-center justify-content-between mb-4">
			                        <a href="AgregarEvaluacion.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
			                        class="fas fa-plus fa-sm text-white-50"></i> Agregar Nueva Evaluación</a>                                           
			                    </div>
							</div>
						</div>
					</div>
	...
	<script>
	function valoreditar(idevaluacion)
	{

...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Modulo Evaluación - Editar Facultad</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                     <h1 class="h3 mb-2 text-gray-800">Editar  Facultad</h1>
                    <nav aria-label="breadcrumb">
                 				 <ol class="breadcrumb">
								    <li class="breadcrumb-item"><a href="index.jsp">Inicio</a></li>
								    <li class="breadcrumb-item"><a href="ListaFacultad.jsp">Lista de Facultades</a></li>
								    <li class="breadcrumb-item active" aria-current="EditarFacultad.jsp">Editar Facultad</li>
								  </ol>
								</nav>
					...
					f= dtf.getFacultad(Integer.parseInt(idfacultad));
            		 %>
					<form class="form-group" method="post" action="./SLgestionFacultad">
						<div class="form-group">
						<input hidden="true" name="idfacultad" value="<%=idfacultad%>">
						<input type="hidden" id="opcion" name="opcion" value="2" required />
							...
							<div class="col-sm-6">
								...
								data-placement="bottom" title="Min:20 Max:50"  value="<%=f.getNombre()%>" required >
							</div>
					       ...
					       <label class="col-sm-2 control-label text-rpromedix">Correo: </label>
							<div class="col-sm-6">
								...
								data-placement="bottom" title="Min:10 Max:45"  value="<%=f.getCorreo()%>" required>
							</div>
						...
						<div class="col-sm-6">
							...
							data-placement="bottom" title="Max:8"  value="<%=f.getTelefono()%>" required>
						</div>	
						...
						<div class="col-sm-6">
							...
							data-placement="bottom" title="Min:2 Max:4" value="<%=f.getExtension_telefonica()%>">
						</div>	
						...
						<div class="col-sm-6">
							...
							data-placement="bottom" title="Min:10 Max:50"  value="<%=f.getDireccion()%>" required>
						</div>						  					  
					</div>

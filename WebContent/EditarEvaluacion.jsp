...
<title>Modulo Evaluación- Editar Evaluacion</title>
						...
						<label class="col-sm-2 control-label text-rpromedix">Periodo PPP</label>
						    <div class="col-sm-6">
						      <select name="idperiodoppp"class="form-control" required>
								...
								{ if(p.getIdperiodoppp()==e.getIdPeriodoPPP()){
								%>
							...
							<div class="col-sm-6">
								...
								data-placement="bottom" title="Min:2 Max:120" value="<%=e.getUrl() %>" required>							
							</div>
						
						<label class="col-sm-2 control-label text-rpromedix">Estado</label>
						    <div class="col-sm-6">
						      <select name="estado"class="form-control" required>
						      	<option value="<%=e.getEstado()%>"></option>

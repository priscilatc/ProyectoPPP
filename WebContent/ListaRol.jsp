...
<meta name="author" content="">
    ...
    <title>Modulo Evaluación- Lista de Roles</title>
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
				 				  <ol class="breadcrumb">
								    ...
								    <li class="breadcrumb-item active" aria-current="ListaRol.jsp">Lista de Roles</li>
								  </ol>
								</nav>
           		...
           		<!-- DataTales Example -->
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Lista de Roles 
							<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" 
                           title="Lista de los roles pueden o han sido asignados a un usuario,  en esta sección podrás agregar un nuevo rol, agregar opciones a un rol, buscar, editar o eliminar sus datos."></i>	
                           </h6>
						</div>
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered" id="tblrol" width="100%"
                                    ...
                                    <%
										...
										<tr>
											...
											<td>
                    						<span>
                    							<a onclick="valoreditar(<%=r.getIdRol() %>)">
                    						...
                    						<span>
									            	<a onclick="agregarOpcion(<%=r.getIdRol() %>)">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
			                        <a href="AgregarRol.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
			                        class="fas fa-plus fa-sm text-white-50"></i> Agregar Nuevo Rol</a>                                           
			                    </div>  
                            </div>
                        </div>
                    </div>
   ...
   <!-- Logout Modal-->
    ...
    <script type="text/javascript">
		...
		{
			window.location.href="EditarRol.jsp?idrol="+idrol;
			location.reload
		}		
		function eliminarRol(id)
		{
            ...
            confirm(function(e, btn){
                e.preventDefault();
                window.location.href = "SLeliminarRol?id="+id;
            },
            function(e,btn){
                e.preventDefault();
            });
		}
		function agregarOpcion(idrol)
		{
			window.location.href="AgregarRolOpcion.jsp?idrol="+idrol;
			location.reload
		}
		</script>
	<script>

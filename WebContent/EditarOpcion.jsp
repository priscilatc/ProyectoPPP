...
<title>Modulo Evaluación - Editar Opción</title>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					o =dto.getOpc(Integer.parseInt(idopcion));
            		 %>
					...
					<div class="form-group">
						...
						placeholder="Ej:Agrega un nuevo docente" data-toggle="tooltip"   minlength="10" maxlength="30"
							data-placement="bottom" title="Min:10 Max:30" value="<%=o.getDescripcion()%>">
						</div>
						...
						<div class="col-sm-6">
							...
							data-placement="bottom" title="Min:6 Max:30" value="<%=o.getUrl()%>">
						</div>
					</div>

...
<title>Modulo Evaluación- Agregar de Asignaciones de Tutores</title>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Agregar a Asignación de Tutores </h1>
					
					<nav aria-label="breadcrumb">
								  <ol class="breadcrumb">
								    <li class="breadcrumb-item"><a href="index.jsp">Inicio</a></li>
								    <li class="breadcrumb-item"><a href="ListaAsignacionTutores.jsp">Lista de Asignación de Tutores</a></li>
								    <li class="breadcrumb-item active" aria-current="AgregarAsignacionTutores.jsp">Agregar  Asignación de Tutores</li>
								  </ol>
								</nav>                 
            		 <div class="card-body">
               		<%
					...
					<form class="form-group" method="post" action="./SLgestionAsignacion">					
						...
						<input type="hidden" id="opcion" name="opcion" value="1" required />
						 <input hidden="true" name="idasignacion" value="<%=idasignacion%>">
							<label class="col-sm-2 control-label text-rpromedix">Tutor Tecnico</label>
								    <div class="col-sm-6">
								      <select name="idtutor" id="idtutor" class="form-control" required>
							...
							<div class="col-sm-6">
								...
								placeholder="Ej:Excelente estudiante" data-toggle="tooltip" minlength="10" maxlength="100"
								data-placement="bottom" title="Min:10 Max:100">
							</div>				
		...
		$(document).ready(function ()
        	    {
        	        ...
        	        if(mensaje == "1")
        	        {
        	            errorAlert('Error', 'El Estudiante que desea asignar ya ha sido asignado dentro del sistema');
        	        }
        	    });
		</script>

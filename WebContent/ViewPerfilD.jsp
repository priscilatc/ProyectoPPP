...
<%
    //Limpia la CACHE del navegador
		...
		VW_docente e = new VW_docente();
		
		e = dtd.getPerfil(dtu.conseguirID(loginUser));
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Perfil Personal</h1>
						...
						<div class="card-header py-3">
							...
							<div class="table-responsive">
								<table class="table borderless" id="tblInfo" width="130px"
									cellspacing="0">															
									<tbody>
									<tr><th WIDTH="50" >Nombre</th><td><%=e.getNombre() %></td></tr>									
                                    <tr><th WIDTH="50" >Correo</th><td><%=e.getCorreo()%></td></tr>
                                    <tr><th WIDTH="50" >Cargo</th><td><%=e.getCargo()%></td></tr>
                                    <tr><th WIDTH="50" >Trato</th><td><%=e.getTrato()%></td></tr>
                                    <tr><th WIDTH="50" >Categoria</th><td><%=e.getCategoria()%></td></tr>  
                                    <tr><th WIDTH="50" >Coordinación</th><td><%=e.getCoordinacion()%></td></tr>                                                               
									<tr><th WIDTH="50" >Editar Perfil</th><td><span>
                    							<a onclick="editar(<%=e.getIdusuario()%>)">Editar</a>           			                   							
                   							</span></td></tr>
									</tbody>
								</table>

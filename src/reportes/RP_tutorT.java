...
/**
 * Servlet implementation class RP_tutorT
 */
@WebServlet("/RP_tutorT")
public class RP_tutorT extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try 
		{
			...
			String template = "Reportes\\TutoresTecnicos.jasper";
			
			Exporter exporter = new JRPdfExporter();
			JasperPrint jasperPrint = JasperFillManager.fillReport(path+template,hm,c);
			response.setContentType("application/pdf");
			response.setHeader("Content-Disposition",  "inline; filename=TutoresTecnicos.pdf");

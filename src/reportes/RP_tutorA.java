...
/**
 * Servlet implementation class RP_tutorA
 */
@WebServlet("/RP_tutorA")
public class RP_tutorA extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try 
		{
			...
			String template = "Reportes\\TutoresAcademicos.jasper";
			
			Exporter exporter = new JRPdfExporter();
			JasperPrint jasperPrint = JasperFillManager.fillReport(path+template,hm,c);
			response.setContentType("application/pdf");
			response.setHeader("Content-Disposition",  "inline; filename=TutoresAcademicos.pdf");
